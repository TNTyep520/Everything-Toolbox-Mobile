...
public final class SelectInstance<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, kotlinx.coroutines.selects.SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
        ...
        while (true) {
            ...
            if (result$iv == SelectKt.UNDECIDED) {
                ...
                if (result$iv == update$iv2) {
                    if (_result$FU.compareAndSet(this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                        if (Result.m68isFailureimpl(result)) {
                            Continuation<R> continuation = this.uCont;
                            Throwable exception$iv = Result.m65exceptionOrNullimpl(result);
                            ...
                            continuation.resumeWith(Result.m62constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame)));
                            return;
                        }
    ...
    public void resumeSelectWithException(Throwable exception) {
        ...
        while (true) {
            ...
            if (result$iv == SelectKt.UNDECIDED) {
                ...
                if (_result$FU.compareAndSet(this, SelectKt.UNDECIDED, new CompletedExceptionally(thRecoverFromStackFrame, false, 2, null))) {
                    return;
                }
            } else {
                Object update$iv = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                if (result$iv == update$iv) {
                    if (_result$FU.compareAndSet(this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                        Continuation continuationIntercepted = IntrinsicsKt.intercepted(this.uCont);
                        Result.Companion companion = Result.INSTANCE;
                        continuationIntercepted.resumeWith(Result.m62constructorimpl(ResultKt.createFailure(exception)));
                        return;
                    }
                } else {
                    throw new IllegalStateException("Already resumed");
    ...
    /* JADX INFO: compiled from: Select.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\b\u0082\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0013\u0010\u0003\u001a\u00020\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006H\u0096\u0002¨\u0006\u0007"}, d2 = {"Lkotlinx/coroutines/selects/SelectBuilderImpl$SelectOnCancelling;", "Lkotlinx/coroutines/JobCancellingNode;", "(Lkotlinx/coroutines/selects/SelectBuilderImpl;)V", "invoke", HttpUrl.FRAGMENT_ENCODE_SET, "cause", HttpUrl.FRAGMENT_ENCODE_SET, "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 48)
    ...
    public final void handleBuilderException(Throwable e) {
        if (trySelect()) {
            Result.Companion companion = Result.INSTANCE;
            resumeWith(Result.m62constructorimpl(ResultKt.createFailure(e)));
    ...
    */
    ...
    private static final class PairSelectOp extends OpDescriptor {
        ...
        public Object perform(Object affected) {
            ...
            SelectInstance._state$FU.compareAndSet(impl, this, update);
            return decision;
        }
    ...
    /* JADX INFO: compiled from: Select.kt */
    @Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0002\u0018\u00002\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001B\u0019\u0012\n\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u001c\u0010\f\u001a\u00020\r2\b\u0010\u000e\u001a\u0004\u0018\u00010\u00022\b\u0010\u000f\u001a\u0004\u0018\u00010\u0002H\u0016J\u0012\u0010\u0010\u001a\u00020\r2\b\u0010\u000f\u001a\u0004\u0018\u00010\u0002H\u0002J\u0014\u0010\u0011\u001a\u0004\u0018\u00010\u00022\b\u0010\u000e\u001a\u0004\u0018\u00010\u0002H\u0016J\n\u0010\u0012\u001a\u0004\u0018\u00010\u0002H\u0002J\b\u0010\u0013\u001a\u00020\u0014H\u0016J\b\u0010\u0015\u001a\u00020\rH\u0002R\u0010\u0010\u0005\u001a\u00020\u00068\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\b\u001a\u00020\tX\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000b¨\u0006\u0016"}, d2 = {"Lkotlinx/coroutines/selects/SelectBuilderImpl$AtomicSelectOp;", "Lkotlinx/coroutines/internal/AtomicOp;", HttpUrl.FRAGMENT_ENCODE_SET, "impl", "Lkotlinx/coroutines/selects/SelectBuilderImpl;", "desc", "Lkotlinx/coroutines/internal/AtomicDesc;", "(Lkotlinx/coroutines/selects/SelectBuilderImpl;Lkotlinx/coroutines/internal/AtomicDesc;)V", "opSequence", HttpUrl.FRAGMENT_ENCODE_SET, "getOpSequence", "()J", "complete", HttpUrl.FRAGMENT_ENCODE_SET, "affected", "failure", "completeSelect", "prepare", "prepareSelectOp", "toString", HttpUrl.FRAGMENT_ENCODE_SET, "undoPrepare", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 48)
    private static final class AtomicSelectOp extends AtomicOp<Object> {
        ...
        private final void completeSelect(Object failure) {
            ...
            if (SelectInstance._state$FU.compareAndSet(this.impl, this, update) && selectSuccess) {
