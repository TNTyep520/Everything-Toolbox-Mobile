...
public interface ReceiveChannel<E> {
    ...
    Object mo1458receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1459tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1459tryReceivePtdJZtk = receiveChannel.mo1459tryReceivePtdJZtk();
            if (ChannelResult.m1475isSuccessimpl(objMo1459tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1471getOrThrowimpl(objMo1459tryReceivePtdJZtk);
            }
            Throwable thM1469exceptionOrNullimpl = ChannelResult.m1469exceptionOrNullimpl(objMo1459tryReceivePtdJZtk);
            if (thM1469exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1469exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L38:
                ...
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.mo1458receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L45
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1470getOrNullimpl(r3)
                return r3
            */
