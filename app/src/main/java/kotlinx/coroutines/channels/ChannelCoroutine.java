...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo1458receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo1458receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo1459tryReceivePtdJZtk() {
        return this._channel.mo1459tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo1460trySendJP2dKIU(E element) {
        return this._channel.mo1460trySendJP2dKIU(element);
    }
