...
public final class CoroutineScopeKt {
    ...
    public static final CoroutineScope MainScope() {
        ...
        return new kotlinx.coroutines.internal.CoroutineScope(completableJobSupervisorJob$default.plus(Dispatchers.getMain()));
    }
