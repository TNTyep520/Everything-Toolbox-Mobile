...
public final class FlowKt__ZipKt$combineTransformUnsafe$1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (CombineKt.combineInternal($this$flow, this.$flows, FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt(), new AnonymousClass1(this.$transform, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                break;
            case 1:
    ...
    public final Object invokeSuspend$$forInline(Object $result) {
        FlowCollector $this$flow = (FlowCollector) this.L$0;
        InlineMarker.mark(0);
        CombineKt.combineInternal($this$flow, this.$flows, FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt(), new AnonymousClass1(this.$transform, null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
