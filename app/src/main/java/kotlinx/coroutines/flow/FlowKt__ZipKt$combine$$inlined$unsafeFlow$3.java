...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$3<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Object objCombineInternal = CombineKt.combineInternal(flowCollector, flowArr, new FlowKt__ZipKt$combine$6$1(this.$flowArray$inlined), new FlowKt__ZipKt$combine$6$2(this.$transform$inlined, null), continuation);
