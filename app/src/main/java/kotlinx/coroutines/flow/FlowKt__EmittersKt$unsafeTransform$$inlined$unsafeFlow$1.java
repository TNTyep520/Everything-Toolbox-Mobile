...
public final class FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Object objCollect = $this$collect$iv.collect(new FlowKt__EmittersKt$unsafeTransform$lambda1$$inlined$collect$1(this.$transform$inlined, flowCollector), continuation);
