...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$2<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Object objCombineInternal = CombineKt.combineInternal(flowCollector, flowArr, new FlowKt__ZipKt$combine$5$1(this.$flows$inlined), new FlowKt__ZipKt$combine$5$2(this.$transform$inlined, null), continuation);
