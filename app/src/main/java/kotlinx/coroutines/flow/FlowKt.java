...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1484debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt__DelayKt.m1486debounceHG0u8IE(flow, timeout);
    }
    ...
    public static final <T> Flow<T> m1485sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt__DelayKt.m1487sampleHG0u8IE(flow, period);
    }
