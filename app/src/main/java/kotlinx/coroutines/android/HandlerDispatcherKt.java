...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM62constructorimpl = Result.m62constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM62constructorimpl = Result.m62constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m68isFailureimpl(objM62constructorimpl) ? null : objM62constructorimpl);
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1504dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1456postFrameCallback$lambda6(cancellableContinuation, j);
            }
        });
    }
    ...
    public static final void m1456postFrameCallback$lambda6(CancellableContinuation $cont, long nanos) {
        Dispatchers dispatchers = Dispatchers.INSTANCE;
