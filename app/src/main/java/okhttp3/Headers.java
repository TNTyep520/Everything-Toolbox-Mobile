...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public final int m1565deprecated_size() {
        return size();
    }
    ...
    public static final class Builder {
        ...
        public final Builder addLenient$okhttp(String line) {
            ...
            if (index != -1) {
                ...
                $this$apply.addLenient$okhttp(HttpUrl.FRAGMENT_ENCODE_SET, strSubstring3);
            } else {
                $this$apply.addLenient$okhttp(HttpUrl.FRAGMENT_ENCODE_SET, line);
            }
            return this;
        }
    ...
    public static final class Companion {
        ...
        public final Headers m1567deprecated_of(String... namesAndValues) {
            Intrinsics.checkNotNullParameter(namesAndValues, "namesAndValues");
        ...
        /* JADX INFO: renamed from: -deprecated_of, reason: not valid java name */
        public final Headers m1566deprecated_of(Map<String, String> headers) {
            Intrinsics.checkNotNullParameter(headers, "headers");
            return of(headers);
        }
        ...
        public final void checkValue(String value, String name) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (!(c == '\t' || (' ' <= c && '~' >= c))) {
                    ...
                    sb.append(Util.format("Unexpected char %#04x at %d in %s value", Integer.valueOf(c), Integer.valueOf(i), name));
