...
public final class Response implements Closeable {
    ...
    public final CacheControl m1635deprecated_cacheControl() {
        return cacheControl();
    }
