...
public final class Address {
    ...
    public final List<Protocol> m1521deprecated_protocols() {
        return this.protocols;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "connectionSpecs", imports = {}))
    /* JADX INFO: renamed from: -deprecated_connectionSpecs, reason: not valid java name */
    public final List<ConnectionSpec> m1518deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((((((result * 31) + this.dns.hashCode()) * 31) + this.proxyAuthenticator.hashCode()) * 31) + this.protocols.hashCode()) * 31) + this.connectionSpecs.hashCode()) * 31) + this.proxySelector.hashCode()) * 31) + Address$$ExternalSyntheticBackport0.m(this.proxy)) * 31) + Address$$ExternalSyntheticBackport0.m(this.sslSocketFactory)) * 31) + Address$$ExternalSyntheticBackport0.m(this.hostnameVerifier)) * 31) + Address$$ExternalSyntheticBackport0.m(this.certificatePinner);
    }
