...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m1544deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1546deprecated_tlsVersions() {
        return tlsVersions();
    }
