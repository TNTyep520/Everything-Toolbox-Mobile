...
public final /* data */ class WebSocketExtensions {
    ...
    /* JADX INFO: compiled from: WebSocketExtensions.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Lokhttp3/internal/ws/WebSocketExtensions$Companion;", HttpUrl.FRAGMENT_ENCODE_SET, "()V", "HEADER_WEB_SOCKET_EXTENSION", HttpUrl.FRAGMENT_ENCODE_SET, "parse", "Lokhttp3/internal/ws/WebSocketExtensions;", "responseHeaders", "Lokhttp3/Headers;", "okhttp"}, k = 1, mv = {1, 4, 0})
            ...
            while (i < size) {
                ...
                if (StringsKt.equals(responseHeaders2.name(i), WebSocketExtensions.HEADER_WEB_SOCKET_EXTENSION, true)) {
                    ...
                    while (pos < header.length()) {
                        ...
                        if (StringsKt.equals(extensionToken2, "permessage-deflate", z)) {
                            ...
                            while (pos < extensionEnd) {
                                ...
                                pos = parameterEnd + 1;
                                boolean unexpectedValues3 = unexpectedValues2;
                                if (StringsKt.equals(name, "client_max_window_bits", true)) {
                                    boolean unexpectedValues4 = clientMaxWindowBits != null ? true : unexpectedValues3;
                                    ...
                                    if (clientMaxWindowBits2 == null) {
                                        ...
                                        clientMaxWindowBits = clientMaxWindowBits2;
                                        unexpectedValues = unexpectedValues4;
                                    }
                                } else if (StringsKt.equals(name, "client_no_context_takeover", true)) {
                                    boolean unexpectedValues5 = clientNoContextTakeover ? true : unexpectedValues3;
                                    if (value != null) {
                                        unexpectedValues5 = true;
                                    }
                                    clientNoContextTakeover = true;
                                    unexpectedValues = unexpectedValues5;
                                } else if (StringsKt.equals(name, "server_max_window_bits", true)) {
                                    boolean unexpectedValues6 = serverMaxWindowBits != null ? true : unexpectedValues3;
                                    ...
                                    if (serverMaxWindowBits2 == null) {
                                        ...
                                        serverMaxWindowBits = serverMaxWindowBits2;
                                        unexpectedValues = unexpectedValues6;
                                    }
                                } else if (StringsKt.equals(name, "server_no_context_takeover", true)) {
                                    unexpectedValues = serverNoContextTakeover ? true : unexpectedValues3;
                                    if (value != null) {
                                        unexpectedValues = true;
                                    }
                                ...
                                unexpectedValues2 = unexpectedValues;
                                compressionEnabled2 = compressionEnabled;
                                extensionToken2 = extensionToken;
                            }
                            unexpectedValues2 = unexpectedValues2;
                        } else {
                            unexpectedValues2 = true;
                        }
                        z = true;
