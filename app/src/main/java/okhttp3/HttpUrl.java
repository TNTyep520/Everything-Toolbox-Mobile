...
public final class HttpUrl {
    ...
    public final String m1573deprecated_encodedUsername() {
    ...
    public final String m1569deprecated_encodedPassword() {
    ...
    public static final class Builder {
        ...
        public final Builder fragment(String fragment) {
            Builder $this$apply = this;
            $this$apply.encodedFragment = fragment != null ? Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, fragment, 0, 0, HttpUrl.FRAGMENT_ENCODE_SET, false, false, false, true, null, 187, null) : null;
            return this;
        }

        public final Builder encodedFragment(String encodedFragment) {
            Builder $this$apply = this;
            $this$apply.encodedFragment = encodedFragment != null ? Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedFragment, 0, 0, HttpUrl.FRAGMENT_ENCODE_SET, true, false, false, true, null, 179, null) : null;
            return this;
        }
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            $this$apply.host = str != null ? new Regex("[\"<>^`{|}]").replace(str, HttpUrl.FRAGMENT_ENCODE_SET) : null;
        ...
        */
        ...
        public final Builder parse$okhttp(HttpUrl base, String input) {
            ...
            if (slashCount2 >= 2 || base == null || (!Intrinsics.areEqual(base.scheme(), this.scheme))) {
                ...
                while (true) {
                    ...
                    if (componentDelimiterOffset2 != limit) {
                        iCharAt = input.charAt(componentDelimiterOffset2);
                    } else {
                        iCharAt = -1;
                    }
                    int c = iCharAt;
                    switch (c) {
                        ...
                        case 92:
                            ...
                            int portColonOffset = companion2.portColonOffset(input, pos4, componentDelimiterOffset2);
                            if (portColonOffset + 1 < componentDelimiterOffset2) {
                                ...
                                int port = companion2.parsePort(input, portColonOffset + 1, componentDelimiterOffset2);
                                this.port = port;
                                if (!(port != -1)) {
                                    StringBuilder sb2 = new StringBuilder();
                                    sb2.append("Invalid URL port: \"");
                                    String strSubstring2 = input.substring(portColonOffset + 1, componentDelimiterOffset2);
                                    Intrinsics.checkNotNullExpressionValue(strSubstring2, str6);
                        ...
                        case 64:
                            if (!hasPassword) {
                                ...
                                sb4.append("%40");
                                componentDelimiterOffset = componentDelimiterOffset2;
                                sb4.append(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, pos3, componentDelimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, 240, null));
            ...
            if (pos < limit && input.charAt(pos) == '#') {
                this.encodedFragment = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, pos + 1, limit, HttpUrl.FRAGMENT_ENCODE_SET, true, false, false, true, null, 176, null);
            }
            return this;
        }
    ...
    public static final class Companion {
        ...
        */
        ...
        public final HttpUrl m1587deprecated_get(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m1590deprecated_parse(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m1589deprecated_get(URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m1588deprecated_get(URI uri) {
