...
public final class UStringsKt {
    ...
    public static final String m1334toStringLxnNnR4(byte $this$toString, int radix) {
    ...
    public static final String m1336toStringolVBNx4(short $this$toString, int radix) {
    ...
    public static final String m1335toStringV7xB4Y4(int $this$toString, int radix) {
        String string = Long.toString(((long) $this$toString) & 4294967295L, CharsKt.checkRadix(radix));
    ...
    public static final String m1333toStringJSWoG40(long $this$toString, int radix) {
    ...
    public static final UByte toUByteOrNull(String toUByteOrNull, int radix) {
        ...
        if (UnsignedKt.uintCompare(data, UInt.m156constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m74boximpl(UByte.m80constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (UnsignedKt.uintCompare(data, UInt.m156constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m334boximpl(UShort.m340constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m156constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m409uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            int result2 = UInt.m156constructorimpl(result * uradix);
            result = UInt.m156constructorimpl(UInt.m156constructorimpl(digit) + result2);
            if (UnsignedKt.uintCompare(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m150boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m234constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                if (limitBeforeMul == 512409557603043100L) {
                    limitBeforeMul = UnsignedKt.m411ulongDivideeb3DHEI(-1L, uradix);
                    if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                        return null;
                    }
                } else {
            ...
            long result2 = ULong.m234constructorimpl(result * uradix);
            result = ULong.m234constructorimpl(ULong.m234constructorimpl(((long) UInt.m156constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m228boximpl(result);
    }
}
