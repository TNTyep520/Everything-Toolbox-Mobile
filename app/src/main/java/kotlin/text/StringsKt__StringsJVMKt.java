...
public class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final byte[] encodeToByteArray(String encodeToByteArray, int startIndex, int endIndex, boolean throwOnInvalidSequence) throws CharacterCodingException {
        Intrinsics.checkNotNullParameter(encodeToByteArray, "$this$encodeToByteArray");
