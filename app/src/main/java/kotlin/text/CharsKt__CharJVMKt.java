...
public class CharsKt__CharJVMKt {
    ...
    public static final String titlecase(char $this$titlecase, Locale locale) {
        ...
        Intrinsics.checkNotNullExpressionValue(strValueOf.toUpperCase(Locale.ROOT), "(this as java.lang.Strin….toUpperCase(Locale.ROOT)");
        if (!Intrinsics.areEqual(localizedUppercase, r1)) {
            return localizedUppercase;
        }
