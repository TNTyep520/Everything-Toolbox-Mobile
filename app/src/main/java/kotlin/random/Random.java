...
public abstract class Random {
        ...
        if (n > 0) {
            if (((-n) & n) == n) {
                ...
                if (nLow != 0) {
                    ...
                    jNextBits = 4294967295L & ((long) nextBits(bitCount));
                } else if (nHigh == 1) {
                    jNextBits = 4294967295L & ((long) nextInt());
                } else {
                    int bitCount2 = RandomKt.fastLog2(nHigh);
                    jNextBits = (((long) nextBits(bitCount2)) << 32) + ((long) nextInt());
                }
                rnd = jNextBits;
            } else {
                do {
    ...
    */
    ...
    public static final class Companion extends Random implements Serializable {
        ...
        /* JADX INFO: compiled from: Random.kt */
        @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0000\n\u0000\bÂ\u0002\u0018\u00002\u00060\u0001j\u0002`\u0002B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\b\u0010\u0006\u001a\u00020\u0007H\u0002R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000¨\u0006\b"}, d2 = {"Lkotlin/random/Random$Default$Serialized;", "Ljava/io/Serializable;", "Lkotlin/io/Serializable;", "()V", "serialVersionUID", HttpUrl.FRAGMENT_ENCODE_SET, "readResolve", HttpUrl.FRAGMENT_ENCODE_SET, "kotlin-stdlib"}, k = 1, mv = {1, 5, 1})
