...
class URangesKt___URangesKt {
    ...
    public static final UInt randomOrNull(UIntRange randomOrNull, Random random) {
        ...
        return UInt.m150boximpl(URandomKt.nextUInt(random, randomOrNull));
    }
    ...
    public static final ULong randomOrNull(ULongRange randomOrNull, Random random) {
        ...
        return ULong.m228boximpl(URandomKt.nextULong(random, randomOrNull));
    }

    /* JADX INFO: renamed from: contains-biwQdVI, reason: not valid java name */
    private static final boolean m1298containsbiwQdVI(UIntRange contains, UInt element) {
    ...
    private static final boolean m1294containsGYNo2lE(ULongRange contains, ULong element) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return element != null && contains.m1276containsVKZWuLQ(element.getData());
    }

    /* JADX INFO: renamed from: contains-68kG9v0, reason: not valid java name */
    public static final boolean m1293contains68kG9v0(UIntRange contains, byte value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1270containsWZ4Q5Ns(UInt.m156constructorimpl(value & UByte.MAX_VALUE));
    }

    /* JADX INFO: renamed from: contains-ULb-yJY, reason: not valid java name */
    public static final boolean m1296containsULbyJY(ULongRange contains, byte value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1276containsVKZWuLQ(ULong.m234constructorimpl(((long) value) & 255));
    }

    /* JADX INFO: renamed from: contains-Gab390E, reason: not valid java name */
    public static final boolean m1295containsGab390E(ULongRange contains, int value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1276containsVKZWuLQ(ULong.m234constructorimpl(((long) value) & 4294967295L));
    }

    /* JADX INFO: renamed from: contains-fz5IDCE, reason: not valid java name */
    public static final boolean m1299containsfz5IDCE(UIntRange contains, long value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return ULong.m234constructorimpl(value >>> 32) == 0 && contains.m1270containsWZ4Q5Ns(UInt.m156constructorimpl((int) value));
    }

    /* JADX INFO: renamed from: contains-ZsK3CEQ, reason: not valid java name */
    public static final boolean m1297containsZsK3CEQ(UIntRange contains, short value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1270containsWZ4Q5Ns(UInt.m156constructorimpl(65535 & value));
    }

    /* JADX INFO: renamed from: contains-uhHAxoY, reason: not valid java name */
    public static final boolean m1300containsuhHAxoY(ULongRange contains, short value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1276containsVKZWuLQ(ULong.m234constructorimpl(((long) value) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    /* JADX INFO: renamed from: downTo-Kr8caGY, reason: not valid java name */
    public static final UIntProgression m1303downToKr8caGY(byte $this$downTo, byte to) {
        return UIntProgression.INSTANCE.m1269fromClosedRangeNkh28Cs(UInt.m156constructorimpl($this$downTo & UByte.MAX_VALUE), UInt.m156constructorimpl(to & UByte.MAX_VALUE), -1);
    }

    /* JADX INFO: renamed from: downTo-J1ME1BU, reason: not valid java name */
    public static final UIntProgression m1302downToJ1ME1BU(int $this$downTo, int to) {
        return UIntProgression.INSTANCE.m1269fromClosedRangeNkh28Cs($this$downTo, to, -1);
    }

    /* JADX INFO: renamed from: downTo-eb3DHEI, reason: not valid java name */
    public static final ULongProgression m1304downToeb3DHEI(long $this$downTo, long to) {
        return ULongProgression.INSTANCE.m1275fromClosedRange7ftBX0g($this$downTo, to, -1L);
    }

    /* JADX INFO: renamed from: downTo-5PvTz6A, reason: not valid java name */
    public static final UIntProgression m1301downTo5PvTz6A(short $this$downTo, short to) {
        return UIntProgression.INSTANCE.m1269fromClosedRangeNkh28Cs(UInt.m156constructorimpl($this$downTo & UShort.MAX_VALUE), UInt.m156constructorimpl(65535 & to), -1);
    }

    public static final UIntProgression reversed(UIntProgression reversed) {
        Intrinsics.checkNotNullParameter(reversed, "$this$reversed");
        return UIntProgression.INSTANCE.m1269fromClosedRangeNkh28Cs(reversed.getLast(), reversed.getFirst(), -reversed.getStep());
    }

    public static final ULongProgression reversed(ULongProgression reversed) {
        Intrinsics.checkNotNullParameter(reversed, "$this$reversed");
        return ULongProgression.INSTANCE.m1275fromClosedRange7ftBX0g(reversed.getLast(), reversed.getFirst(), -reversed.getStep());
    }
    ...
    public static final UIntProgression step(UIntProgression step, int step2) {
        ...
        return UIntProgression.INSTANCE.m1269fromClosedRangeNkh28Cs(step.getFirst(), step.getLast(), step.getStep() > 0 ? step2 : -step2);
    }
    ...
    public static final ULongProgression step(ULongProgression step, long step2) {
        ...
        return ULongProgression.INSTANCE.m1275fromClosedRange7ftBX0g(step.getFirst(), step.getLast(), step.getStep() > 0 ? step2 : -step2);
    }

    /* JADX INFO: renamed from: until-Kr8caGY, reason: not valid java name */
    public static final UIntRange m1307untilKr8caGY(byte $this$until, byte to) {
        return Intrinsics.compare(to & UByte.MAX_VALUE, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m156constructorimpl($this$until & UByte.MAX_VALUE), UInt.m156constructorimpl(UInt.m156constructorimpl(to & UByte.MAX_VALUE) - 1), null);
    }

    /* JADX INFO: renamed from: until-J1ME1BU, reason: not valid java name */
    public static final UIntRange m1306untilJ1ME1BU(int $this$until, int to) {
        return UnsignedKt.uintCompare(to, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange($this$until, UInt.m156constructorimpl(to - 1), null);
    }

    /* JADX INFO: renamed from: until-eb3DHEI, reason: not valid java name */
    public static final ULongRange m1308untileb3DHEI(long $this$until, long to) {
        return UnsignedKt.ulongCompare(to, 0L) <= 0 ? ULongRange.INSTANCE.getEMPTY() : new ULongRange($this$until, ULong.m234constructorimpl(to - ULong.m234constructorimpl(((long) 1) & 4294967295L)), null);
    }

    /* JADX INFO: renamed from: until-5PvTz6A, reason: not valid java name */
    public static final UIntRange m1305until5PvTz6A(short $this$until, short to) {
        return Intrinsics.compare(to & UShort.MAX_VALUE, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m156constructorimpl($this$until & UShort.MAX_VALUE), UInt.m156constructorimpl(UInt.m156constructorimpl(65535 & to) - 1), null);
    }

    /* JADX INFO: renamed from: coerceAtLeast-J1ME1BU, reason: not valid java name */
    public static final int m1280coerceAtLeastJ1ME1BU(int $this$coerceAtLeast, int minimumValue) {
    ...
    public static final long m1282coerceAtLeasteb3DHEI(long $this$coerceAtLeast, long minimumValue) {
    ...
    public static final byte m1281coerceAtLeastKr8caGY(byte $this$coerceAtLeast, byte minimumValue) {
    ...
    public static final short m1279coerceAtLeast5PvTz6A(short $this$coerceAtLeast, short minimumValue) {
    ...
    public static final int m1284coerceAtMostJ1ME1BU(int $this$coerceAtMost, int maximumValue) {
    ...
    public static final long m1286coerceAtMosteb3DHEI(long $this$coerceAtMost, long maximumValue) {
    ...
    public static final byte m1285coerceAtMostKr8caGY(byte $this$coerceAtMost, byte maximumValue) {
    ...
    public static final short m1283coerceAtMost5PvTz6A(short $this$coerceAtMost, short maximumValue) {
    ...
    public static final int m1289coerceInWZ9TVnA(int $this$coerceIn, int minimumValue, int maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + UInt.m201toStringimpl(maximumValue) + " is less than minimum " + UInt.m201toStringimpl(minimumValue) + '.');
    }

    /* JADX INFO: renamed from: coerceIn-sambcqE, reason: not valid java name */
    public static final long m1291coerceInsambcqE(long $this$coerceIn, long minimumValue, long maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ULong.m279toStringimpl(maximumValue) + " is less than minimum " + ULong.m279toStringimpl(minimumValue) + '.');
    }

    /* JADX INFO: renamed from: coerceIn-b33U2AM, reason: not valid java name */
    public static final byte m1290coerceInb33U2AM(byte $this$coerceIn, byte minimumValue, byte maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + UByte.m123toStringimpl(maximumValue) + " is less than minimum " + UByte.m123toStringimpl(minimumValue) + '.');
    }

    /* JADX INFO: renamed from: coerceIn-VKSA0NQ, reason: not valid java name */
    public static final short m1288coerceInVKSA0NQ(short $this$coerceIn, short minimumValue, short maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + UShort.m383toStringimpl(maximumValue) + " is less than minimum " + UShort.m383toStringimpl(minimumValue) + '.');
    }

    /* JADX INFO: renamed from: coerceIn-wuiCnnA, reason: not valid java name */
    public static final int m1292coerceInwuiCnnA(int $this$coerceIn, ClosedRange<UInt> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((UInt) RangesKt.coerceIn(UInt.m150boximpl($this$coerceIn), (ClosedFloatingPointRange<UInt>) range)).getData();
        }
        if (!range.isEmpty()) {
    ...
    public static final long m1287coerceInJPwROB0(long $this$coerceIn, ClosedRange<ULong> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((ULong) RangesKt.coerceIn(ULong.m228boximpl($this$coerceIn), (ClosedFloatingPointRange<ULong>) range)).getData();
        }
        if (!range.isEmpty()) {
