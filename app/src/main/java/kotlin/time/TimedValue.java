...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1435copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1437copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m1437copyRFiDyg4(T value, long duration) {
    ...
    public final long m1438getDurationUwyO8pc() {
        return this.duration;
    }
