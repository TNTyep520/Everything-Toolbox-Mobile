...
public final class DurationKt {
    ...
    private static final long m1431timesmvk6XK0(int $this$times, long duration) {
        return Duration.m1385timesUwyO8pc(duration, $this$times);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1430timeskIfJnKk(double $this$times, long duration) {
        return Duration.m1384timesUwyO8pc(duration, $this$times);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:137:0x028e  */
    /* JADX WARN: Removed duplicated region for block: B:222:0x00db A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:49:0x00c0 A[LOOP:1: B:35:0x0082->B:49:0x00c0, LOOP_END] */
    /*
            ...
            if (!($this$all$iv instanceof Collection) || !((Collection) $this$all$iv).isEmpty()) {
                ...
                while (true) {
                    if (it.hasNext()) {
                        ...
                        int it2 = ('0' <= cCharAt && '9' >= cCharAt) ? 1 : 0;
                        if (it2 == 0) {
                            z = false;
                            break;
                        }
