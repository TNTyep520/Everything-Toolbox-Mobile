...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File $this$toRelativeStringOrNull, File base) {
        ...
        if (sameCount < thisCount) {
            ...
            CollectionsKt.joinTo(CollectionsKt.drop(thisComponents.getSegments(), sameCount), res, (124 & 2) != 0 ? ", " : str, (124 & 4) != 0 ? HttpUrl.FRAGMENT_ENCODE_SET : null, (124 & 8) != 0 ? HttpUrl.FRAGMENT_ENCODE_SET : null, (124 & 16) != 0 ? -1 : 0, (124 & 32) != 0 ? "..." : null, (124 & 64) != 0 ? (Function1) null : null);
        }
        return res.toString();
    }
    ...
    public static final File copyTo(File copyTo, File target, boolean overwrite, int bufferSize) throws FileSystemException {
    ...
    public static final boolean copyRecursively(File copyRecursively, File target, boolean overwrite, final Function2<? super File, ? super IOException, ? extends OnErrorAction> onError) {
        ...
        try {
            for (File src : FilesKt.walkTopDown(copyRecursively).onFail(new Function2<File, IOException, Unit>() { // from class: kotlin.io.FilesKt__UtilsKt.copyRecursively.2
                {
                    super(2);
                }
