...
class NumbersKt__FloorDivModKt extends NumbersKt__BigIntegersKt {
    ...
    private static final double mod(float $this$mod, double other) {
        ...
        Double.isNaN(d);
        double d2 = d % other;
        return (d2 == 0.0d || Math.signum(d2) == Math.signum(other)) ? d2 : d2 + other;
    }
