...
public class Motion implements TypedValues {
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (!splineAttributes.isEmpty()) {
            ...
            Iterator<String> it3 = splineAttributes.iterator();
            while (it3.hasNext()) {
        ...
        if (!timeCycleAttributes2.isEmpty()) {
            ...
            Iterator<String> it5 = timeCycleAttributes2.iterator();
            while (it5.hasNext()) {
                String attribute3 = it5.next();
        ...
        if (this.mKeyList != null) {
            ...
            Iterator<KeyCycleOscillator> it7 = this.mCycleMap.values().iterator();
            while (it7.hasNext()) {
                it7.next().setup(distance);
            }
        }
    }
