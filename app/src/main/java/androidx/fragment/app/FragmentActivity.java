...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private void init() {
        getSavedStateRegistry().registerSavedStateProvider(LIFECYCLE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.FragmentActivity$$ExternalSyntheticLambda1
            ...
            public final Bundle saveState() {
                return this.f$0.m31lambda$init$0$androidxfragmentappFragmentActivity();
            }
        });
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.fragment.app.FragmentActivity$$ExternalSyntheticLambda0
            ...
            public final void onContextAvailable(Context context) {
                this.f$0.m32lambda$init$1$androidxfragmentappFragmentActivity(context);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$init$0$androidx-fragment-app-FragmentActivity, reason: not valid java name */
    public /* synthetic */ Bundle m31lambda$init$0$androidxfragmentappFragmentActivity() {
    ...
    public /* synthetic */ void m32lambda$init$1$androidxfragmentappFragmentActivity(Context context) {
