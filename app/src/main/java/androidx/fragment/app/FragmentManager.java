...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    boolean saveBackStackState(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, String name) {
        ...
        for (int i2 = index; i2 < this.mBackStack.size(); i2++) {
            ...
            if (!affectedFragments.isEmpty()) {
                ...
                sb.append(affectedFragments.size() == 1 ? " " + affectedFragments.iterator().next() : "s " + affectedFragments);
                sb.append(" in ");
                sb.append(record2);
        ...
        if ((obj instanceof SavedStateRegistryOwner) && parent == null) {
            ...
            registry.registerSavedStateProvider(SAVED_STATE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda0
                ...
                public final Bundle saveState() {
                    return this.f$0.m35lambda$attachController$0$androidxfragmentappFragmentManager();
                }
            });
    ...
    /* JADX INFO: renamed from: lambda$attachController$0$androidx-fragment-app-FragmentManager, reason: not valid java name */
    public /* synthetic */ Bundle m35lambda$attachController$0$androidxfragmentappFragmentManager() {
