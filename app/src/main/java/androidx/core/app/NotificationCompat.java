...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        Action(int icon, CharSequence title, PendingIntent intent, Bundle extras, RemoteInput[] remoteInputs, RemoteInput[] dataOnlyRemoteInputs, boolean allowGeneratedReplies, int semanticAction, boolean showsUserInterface, boolean isContextual) {
            this(icon != 0 ? IconCompat.createWithResource(null, HttpUrl.FRAGMENT_ENCODE_SET, icon) : null, title, intent, extras, remoteInputs, dataOnlyRemoteInputs, allowGeneratedReplies, semanticAction, showsUserInterface, isContextual);
        }
        ...
        public static final class Builder {
            ...
            public Builder(int icon, CharSequence title, PendingIntent intent) {
                this(icon != 0 ? IconCompat.createWithResource(null, HttpUrl.FRAGMENT_ENCODE_SET, icon) : null, title, intent, new Bundle(), null, true, 0, true, false);
            }
