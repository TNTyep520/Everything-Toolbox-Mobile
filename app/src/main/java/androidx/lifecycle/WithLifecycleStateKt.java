...
public final class WithLifecycleStateKt {
    ...
    private static final <R> Object withStateAtLeast$$forInline(Lifecycle $this$withStateAtLeast, Lifecycle.State state, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        InlineMarker.mark(0);
        Object objSuspendWithStateAtLeastUnchecked = suspendWithStateAtLeastUnchecked($this$withStateAtLeast, state, dispatchNeeded$iv, lifecycleDispatcher$iv, anonymousClass2, continuation);
        InlineMarker.mark(1);
    ...
    private static final <R> Object withCreated$$forInline(Lifecycle $this$withCreated, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        AnonymousClass2 anonymousClass2 = new AnonymousClass2(function0);
        InlineMarker.mark(0);
        Object objSuspendWithStateAtLeastUnchecked = suspendWithStateAtLeastUnchecked($this$withCreated, state$iv, dispatchNeeded$iv, lifecycleDispatcher$iv, anonymousClass2, continuation);
        InlineMarker.mark(1);
        return objSuspendWithStateAtLeastUnchecked;
    }
    ...
    private static final <R> Object withStarted$$forInline(Lifecycle $this$withStarted, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        AnonymousClass2 anonymousClass2 = new AnonymousClass2(function0);
        InlineMarker.mark(0);
        Object objSuspendWithStateAtLeastUnchecked = suspendWithStateAtLeastUnchecked($this$withStarted, state$iv, dispatchNeeded$iv, lifecycleDispatcher$iv, anonymousClass2, continuation);
        InlineMarker.mark(1);
        return objSuspendWithStateAtLeastUnchecked;
    }
    ...
    private static final <R> Object withResumed$$forInline(Lifecycle $this$withResumed, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        AnonymousClass2 anonymousClass2 = new AnonymousClass2(function0);
        InlineMarker.mark(0);
        Object objSuspendWithStateAtLeastUnchecked = suspendWithStateAtLeastUnchecked($this$withResumed, state$iv, dispatchNeeded$iv, lifecycleDispatcher$iv, anonymousClass2, continuation);
        InlineMarker.mark(1);
        return objSuspendWithStateAtLeastUnchecked;
    }
    ...
    public static final <R> Object withStateAtLeast(LifecycleOwner $this$withStateAtLeast, Lifecycle.State state, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        return suspendWithStateAtLeastUnchecked(lifecycle, state, dispatchNeeded$iv$iv, lifecycleDispatcher$iv$iv, new AnonymousClass2(function0), continuation);
    }
    ...
    private static final <R> Object withStateAtLeast$$forInline(LifecycleOwner $this$withStateAtLeast, Lifecycle.State state, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        AnonymousClass2 anonymousClass2 = new AnonymousClass2(function0);
        InlineMarker.mark(0);
        Object objSuspendWithStateAtLeastUnchecked = suspendWithStateAtLeastUnchecked(lifecycle, state, dispatchNeeded$iv$iv, lifecycleDispatcher$iv$iv, anonymousClass2, continuation);
        InlineMarker.mark(1);
        return objSuspendWithStateAtLeastUnchecked;
    }
    ...
    public static final <R> Object withCreated(LifecycleOwner $this$withCreated, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        return suspendWithStateAtLeastUnchecked(lifecycle, state$iv, dispatchNeeded$iv, lifecycleDispatcher$iv, new AnonymousClass2(function0), continuation);
    }
    ...
    private static final <R> Object withCreated$$forInline(LifecycleOwner $this$withCreated, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        AnonymousClass2 anonymousClass2 = new AnonymousClass2(function0);
        InlineMarker.mark(0);
        Object objSuspendWithStateAtLeastUnchecked = suspendWithStateAtLeastUnchecked(lifecycle, state$iv, dispatchNeeded$iv, lifecycleDispatcher$iv, anonymousClass2, continuation);
        InlineMarker.mark(1);
        return objSuspendWithStateAtLeastUnchecked;
    }
    ...
    private static final <R> Object withStateAtLeastUnchecked$$forInline(Lifecycle $this$withStateAtLeastUnchecked, Lifecycle.State state, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        AnonymousClass2 anonymousClass2 = new AnonymousClass2(function0);
        InlineMarker.mark(0);
        Object objSuspendWithStateAtLeastUnchecked = suspendWithStateAtLeastUnchecked($this$withStateAtLeastUnchecked, state, dispatchNeeded, lifecycleDispatcher, anonymousClass2, continuation);
        InlineMarker.mark(1);
        return objSuspendWithStateAtLeastUnchecked;
    }
            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.upTo(state)) {
                    ...
                    try {
                        ...
                        objM62constructorimpl = Result.m62constructorimpl(function02.invoke());
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.INSTANCE;
                        objM62constructorimpl = Result.m62constructorimpl(ResultKt.createFailure(th));
                    }
                    continuation2.resumeWith(objM62constructorimpl);
                    return;
                }
                if (event == Lifecycle.Event.ON_DESTROY) {
                    ...
                    continuation3.resumeWith(Result.m62constructorimpl(ResultKt.createFailure(lifecycleDestroyedException)));
                }
            }
        };
        if (dispatchNeeded) {
            lifecycleDispatcher.mo1504dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$1
        ...
        co.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2
            ...
            public final void invoke2(Throwable it) {
                if (lifecycleDispatcher.isDispatchNeeded(EmptyCoroutineContext.INSTANCE)) {
                    ...
                    coroutineDispatcher.mo1504dispatch(emptyCoroutineContext, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2.1
                        @Override // java.lang.Runnable
                        public final void run() {
